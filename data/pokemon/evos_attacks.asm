...
GolbatEvosAttacks:
	...
	db 43, VENOSHOCK
	db 48, AIR_SLASH
	db 51, ZEN_HEADBUTT ; Quick Guard → egg move
	db 0 ; no more level-up moves
...
KadabraEvosAttacks:
	...
	db 38, PSYCHIC_M
	db 41, CALM_MIND
	db 43, TRI_ATTACK ; Role Play → new move
	db 46, THUNDER_WAVE
	db 0 ; no more level-up moves
...
ExeggutorAlolanEvosAttacks:
	...
	db 17, DRAGON_DANCE ; Psyshock → new move
	db 27, ZEN_HEADBUTT ; Egg Bomb → tutor move
	db 37, POWER_WHIP ; Wood Hammer → new move
...
TogekissEvosAttacks:
	...
	db 1, AEROBLAST ; Sky Attack → new move
	db 1, EXTREMESPEED
	db 1, AURA_SPHERE
	db 1, AIR_SLASH
	db 1, MOONBLAST ; Sw/Sh move
	db 1, THUNDER_WAVE ; Sw/Sh move
	db 0 ; no more level-up moves
...
OmastarEvosAttacks:
	...
	db 34, RECOVER
	db 37, ANCIENTPOWER
	db 46, TOXIC_SPIKES ; Tickle → new move
	db 54, ROCK_BLAST
	db 65, SHELL_SMASH
	db 73, HYDRO_PUMP
	db 80, POWER_GEM ; new move
	db 0 ; no more level-up moves
...
KabutopsEvosAttacks:
	...
	db 31, AQUA_JET
	db 36, LEECH_LIFE
	db 45, ROCK_SLIDE ; Metal Sound → similar move
	db 54, EARTHQUAKE
	db 63, SWORDS_DANCE ; Wring Out → Let's Go move
	db 72, NIGHT_SLASH
...
BayleefEvosAttacks:
	...
	db 12, HEALINGLIGHT ; Synthesis → similar move
	db 16, DISARM_VOICE
	db 22, BODY_SLAM ; Magical Leaf → new move
...
MeganiumEvosAttacks:
	...
	db 46, PLAY_ROUGH
	db 50, LEECH_SEED
	db 56, MOONBLAST ; Aromatherapy → new move
	db 62, ANCIENTPOWER
	db 66, EARTH_POWER ; Aromatherapy → similar move
	db 72, OUTRAGE ; HGSS tutor move
	db 80, HEAL_BELL ; new move
	db 0 ; no more level-up moves
...
TyphlosionEvosAttacks:
	...
	db 41, POWER_GEM ; Lava Plume → egg move
	db 48, FLAMETHROWER
...
FeraligatrEvosAttacks:
	...
	db 32, AGILITY
	db 37, CRUNCH
	db 45, AQUA_TAIL ; Chip Away → HGSS tutor move
	db 50, ROCK_SLIDE
	db 56, DRAGON_DANCE
	db 62, EARTHQUAKE
...
AriadosEvosAttacks:
	...
	db 58, SLUDGE_BOMB ; Sticky Web → new move
	db 0 ; no more level-up moves
...
XatuEvosAttacks:
	...
	db 43, U_TURN ; Psycho Shift → egg move
	db 49, THUNDER_WAVE
...
AmpharosEvosAttacks:
	...
	db 46, NASTY_PLOT ; Cotton Guard → egg move
	db 51, DAZZLINGLEAM ; Signal Beam → new move
	db 57, HEALINGLIGHT
	db 62, VOLT_SWITCH
	db 65, POWER_GEM
	db 71, FOCUS_BLAST ; HGSS tutor move
	db 0 ; no more level-up moves
...
UmbreonEvosAttacks:
	...
	db 41, DARK_PULSE ; Last Resort → tutor move
	db 45, AURA_SPHERE ; Guard Swap → Mean Look
	db 0 ; no more level-up moves
...
GirafarigEvosAttacks:
	...
	db 19, PSYBEAM
	db 23, AGILITY
	db 28, BODY_SLAM ; Double Hit → egg move
	db 32, ZEN_HEADBUTT
	db 37, CRUNCH
	db 41, ENERGY_BALL
	db 46, NASTY_PLOT
...
CorsolaEvosAttacks:
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, BARRIER ; Harden → similar move
	db 4, WATER_GUN ; Bubble → similar move
	db 8, ROCK_THROW ; Recover → TM move
	db 10, WATER_PULSE
...
SuicuneEvosAttacks:
	...
	db 22, AIR_SLASH
	db 29, LIGHT_SCREEN
	db 36, ICE_BEAM ; Mist → new move
	db 43, MIRROR_COAT
	db 50, SCALD ; Ice Fang → event move
	db 57, EXTREMESPEED ; Tailwind → event move
	db 64, EXTRASENSORY
	db 71, HYDRO_PUMP
	db 78, CALM_MIND
	db 85, AURA_SPHERE ; Blizzard → TM move
	db 92, BLIZZARD
	db 99, HIDDEN_POWER ; TM move
	db 0 ; no more level-up moves
