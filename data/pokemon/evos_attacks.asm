...
PidgeotEvosAttacks:
	...
	db 38, AEROBLAST
	db 40, ROOST
	db 45, U_TURN ; Tailwind → new move
...
VileplumeEvosAttacks:
	...
	db 1, SHADOW_BALL
	db 39, GROWTH
	db 44, DARK_PULSE ; Petal Blizzard → Gloom move
	db 49, PETAL_DANCE
	db 54, HEALINGLIGHT
	db 0 ; no more level-up moves
...
GolemPlainEvosAttacks:
	...
	db 50, DRAGON_DANCE
	db 54, STONE_EDGE
	db 60, CLOSE_COMBAT ; Heavy Slam → similar move
	db 0 ; no more level-up moves
...
FeraligatrEvosAttacks:
	...
	db 32, AGILITY
	db 37, CRUNCH
	db 42, AQUA_TAIL ; Chip Away → HGSS tutor move
	db 46, ROCK_SLIDE
	db 50, DRAGON_DANCE
	db 54, EARTHQUAKE
	db 58, OUTRAGE ; HGSS tutor move
	db 62, WATERFALL
	db 65, CLOSE_COMBAT ; Superpower → similar move
	db 68, BODY_SLAM
	db 0 ; no more level-up moves
