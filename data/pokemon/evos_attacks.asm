...
GyaradosEvosAttacks:
	...
	db 30, AQUA_TAIL
	db 33, ICE_PUNCH
	db 36, SCARY_FACE ; Dragon Rage → GSC TM move
	db 39, CRUNCH
	db 42, FLY
	db 45, EARTHQUAKE
	db 48, DRAGON_DANCE
...
MeganiumEvosAttacks:
	...
	db 46, PLAY_ROUGH
	db 50, LEECH_SEED
	db 56, EARTH_POWER ; Aromatherapy → new move
	db 62, ANCIENTPOWER
...
QuilavaEvosAttacks:
	...
	db 31, DIG
	db 35, SANDSTORM ; Flame Charge → TM move
...
DunsparceEvosAttacks:
	...
	db 48, THUNDER_WAVE
	db 51, DRAGON_PULSE ; Flail → similar move
	db 0 ; no more level-up moves
