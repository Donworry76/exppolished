UniqueWildMoves:
	...
	db CERULEAN_CAPE,    POLIWHIRL,  ZEN_HEADBUTT ; RBY TM move
	db DIGLETTS_CAVE,    DUGTRIO,    MEGAHORN     ; Sw/Sh move
	db ROCK_TUNNEL,      ELECTABUZZ, CRABHAMMER   ; RBY TM move
	...
	db ROCKY_BEACH,      DONPHAN,    WILD_CHARGE  ; HGSS tutor move
	db NOISY_FOREST,     SCIZOR,     CRABHAMMER   ; new move
	db NOISY_FOREST,     PINECO,     PAIN_SPLIT   ; HGSS tutor move
	db SHRINE_RUINS,     HYPNO,      PSYSTRIKE    ; RBY TM move
