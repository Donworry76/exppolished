...
; ================
	...
	db 27, WEAVILE, NO_ITEM, 64, ABILITY_1 | NAT_NEUTRAL, MALE
		db SWORDS_DANCE, ICE_PUNCH, KNOCK_OFF, SHADOW_CLAW
if DEF(FAITHFUL)
...
; ================
	...
	db 67, AERODACTYL, NO_ITEM, 224
		db WING_ATTACK, EARTHQUAKE, STONE_EDGE, ROOST
	db -1 ; end
...
; ================
	...
	db 64, MEW, LEFTOVERS, 240
		db SEISMIC_TOSS, TOXIC, RECOVER, PROTECT
