...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 58, UMBREON, LEFTOVERS, 192, ABILITY_1 | NAT_NEUTRAL, FEMALE
		db RECOVER, TOXIC, FEINT_ATTACK, PROTECT
	db 58, PERSIAN, LEFTOVERS, 192, ABILITY_1 | NAT_NEUTRAL, FEMALE | ALOLAN_FORM
		db NIGHT_SLASH, EXTREMESPEED, SWORDS_DANCE, PLAY_ROUGH
	db 58, TOGEKISS, LEFTOVERS, 192, ABILITY_1 | NAT_NEUTRAL, FEMALE
		db AURA_SPHERE, NASTY_PLOT, THUNDER_WAVE, AIR_SLASH
	db 58, GENGAR, LEFTOVERS, 192, ABILITY_1 | NAT_NEUTRAL, FEMALE
		db HEX, WILL_O_WISP, SLUDGE_BOMB, SUBSTITUTE
	db 58, CLEFABLE, LEFTOVERS, 192, ABILITY_1 | NAT_NEUTRAL, FEMALE
...
; ================
	...
	db 71, UMBREON, LEFTOVERS
		db PROTECT, HEALINGLIGHT, PURSUIT, TOXIC
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 59, GYARADOS, MUSCLE_BAND, 240, ABIL_GYARADOS_INTIMIDATE | NAT_SPD_UP_SATK_DOWN, MALE
