...
; ================
	...
	db 75, MAMOSWINE, HARD_STONE, FAKE_PERFECT_DVS
		db EARTHQUAKE, ICE_SHARD, STONE_EDGE, ANCIENTPOWER
	db -1 ; end
...
; ================
	...
	db 69, WOBBUFFET, SITRUS_BERRY, 240
