...
; ================
	...
	db 22, SYLVEON, NO_ITEM, 48, ABILITY_1 | NAT_NEUTRAL, FEMALE
		db WISH, PROTECT, SHADOW_BALL, MOONBLAST
...
endc
	db 47, KANGASKHAN, NO_ITEM, 128, HIDDEN_ABILITY | NAT_NEUTRAL, FEMALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_MOVES
	; party
	db 52, ARIADOS, FOCUS_SASH, 160
		db TOXIC_SPIKES, SUCKER_PUNCH, U_TURN, GIGA_DRAIN
	db 53, ZAPDOS, LEFTOVERS, 160
		db THUNDERBOLT, ROOST, U_TURN, AEROBLAST
	db 52, FORRETRESS, LEFTOVERS, 160
		db PROTECT, EARTHQUAKE, SPIKES, IRON_HEAD
	db 52, MUK, BRIGHTPOWDER, 160
...
; ================
	...
	db 59, CHARIZARD, WISE_GLASSES, 208, ABIL_CHARIZARD_SOLAR_POWER | NAT_SATK_UP_ATK_DOWN, MALE
if DEF(FAITHFUL)
