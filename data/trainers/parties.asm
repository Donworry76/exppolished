...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 59, GYARADOS, MUSCLE_BAND, 208, ABIL_GYARADOS_INTIMIDATE | NAT_SPD_UP_SATK_DOWN, MALE
		db DRAGON_DANCE, FLY, WATERFALL, EARTHQUAKE
	db 59, DRAGONITE, WIDE_LENS, 208, ABIL_DRAGONITE_INNER_FOCUS | NAT_SATK_UP_ATK_DOWN, MALE
		db FIRE_BLAST, BLIZZARD, THUNDER, ROOST
	db 59, KINGDRA, SCOPE_LENS, 208, ABIL_KINGDRA_SNIPER | NAT_SATK_UP_ATK_DOWN, MALE
		db FOCUS_ENERGY, DRAGON_PULSE, SCALD, ICE_BEAM
	db 59, AERODACTYL, KINGS_ROCK, 208, ABIL_AERODACTYL_TOUGH_CLAWS | NAT_ATK_UP_SATK_DOWN, MALE
		db AERIAL_ACE, EARTHQUAKE, STONE_EDGE, ROOST
	db 60, LUGIA, LEFTOVERS, 208, ABILITY_1 | NAT_SATK_UP_ATK_DOWN, MALE
if DEF(FAITHFUL)
