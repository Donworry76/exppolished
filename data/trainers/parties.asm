...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_MOVES
	; party
	db 66, MOLTRES, LEFTOVERS, 240
if DEF(FAITHFUL)
		db SOLAR_BEAM, ROOST, FIRE_BLAST, U_TURN
else
		db SOLAR_BEAM, ROOST, FIRE_BLAST, U_TURN
endc
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 95, PIKACHU, LIGHT_BALL, ABIL_PIKACHU_STATIC | NAT_SPD_UP_SDEF_DOWN, MALE | PIKACHU_RED_FORM
