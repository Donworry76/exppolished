...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS |  TRAINERTYPE_MOVES
	; party
	db 57, TYRANITAR, AUSSAULT_VEST, 176
...
; ================
	...
	db 59, CELEBI, LEFTOVERS, 192, ABILITY_1 | NAT_NEUTRAL, FEMALE
		db DAZZLINGGLEAM, GIGA_DRAIN, NASTY_PLOT, PSYCHIC_M
	db -1 ; end
...
if DEF(FAITHFUL)
		...
		db SOLAR_BEAM, ROOST, FIRE_BLAST, U_TURN
endc
	db 65, TANGROWTH, AUSSAULT_VEST, 240
...
; ================
	...
	db 24, VICTREEBEL, NO_ITEM, 52
		db SLEEP_POWDER, SUNNY_DAY, SOLAR_BEAM, SLUDGEBOMB
...
; ================
	...
	; party
	db 35, RATICATE, ORAN_BERRY, 80, FAKE_PERFECT_DVS, ABIL_RATICATE_GUTS | NAT_ATK_UP_SATK_DOWN, MALE
...
; ================
	...
	db 42, KINGLER
		db CRAPHAMMER, BODY_SLAM, IRON_HEAD, PROTECT
	db 42, FLAREON
...
; ================
	...
	db 48, GENGAR, LEFTOVERS, ABILITY_1 | NAT_SATK_UP_ATK_DOWN, MALE
		db THUNDERBOLT, WILL_O_WISP, HEX, FCOUS_BLAST
...
; ================
	...
	db 39, VILEPLUME, LEFTOVER, ABILITY_1 | NAT_NEUTRAL, FEMALE
