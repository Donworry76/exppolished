...
; ================
	...
	; party
	db 42, VICTREEBEL
		db WRAP, TOXIC, SLUDGE_BOMB, GIGA_DRAIN
	db 42, KINGLER
		db CRABHAMMER, BODY_SLAM, IRON_HEAD, PROTECT
	db 42, FLAREON
		db MUD_SLAP, QUICK_ATTACK, CRUNCH, SACRED_FIRE
	db -1 ; end
...
; ================
	...
	; party
	db 46, CHARMANDER
		db FLAMETHROWER, SMOKESCREEN, DRAGON_PULSE, SCARY_FACE
	db 46, SQUIRTLE
		db AQUA_JET, HYDRO_PUMP, ICE_BEAM, CRUNCH
	db 46, BULBASAUR
...
; ================
	...
	db 12, GEODUDE, AIR_BALLOON, 12, $DD, $DD, $DD, ABIL_GEODUDE_STURDY | NAT_DEF_UP_SPD_DOWN, MALE
		db DIG, DEFENSE_CURL, MUD_SLAP, ROCK_THROW
