...
; ================
	...
	db 13, Gligar, NO_ITEM, 32
		db TOXIC, AERIAL_ACE, MUD_SLAP, ROOST
...
; ================
	...
	db 16, BUTTERFREE, NO_ITEM, 32, ABILITY_1 | NAT_NEUTRAL, MALE
		db U_TURN, ICY_WIND, SLEEP_POWDER, PSYBEAM
...
; ================
	...
	db 23, MILTANK, LEFTOVERS, 48, ABIL_MILTANK_SCRAPPY | NAT_NEUTRAL, FEMALE
		db CURSE, BODY_SLAM, FRESH_SNACK, ROCK_SLIDE
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 24, WEAVILE, NO_ITEM, 64, ABILITY_1 | NAT_NEUTRAL, MALE
...
if DEF(FAITHFUL)
	...
	db 34, TYPHLOSION, NO_ITEM, 80
		db FLAMETHROWER, FOCUS_BLAST, ROCK_SLIDE, THUNDERPUNCH
endc
...
endc
	db 47, KANGASKHAN, NO_ITEM, 128, HIDDEN_ABILITY | NAT_NEUTRAL, FEMALE
		db BODY_SLAM, DRAGON_DANCE, SUCKER_PUNCH, SHADOW_CLAW
	db 47, KINGDRA, LEFTOVERS, 128, ABIL_KINGDRA_SNIPER | NAT_NEUTRAL, FEMALE
