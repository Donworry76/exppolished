...
; ================
	...
	db 58, PERSIAN, PINK_BOW, 192, ABILITY_1 | NAT_NEUTRAL, FEMALE | ALOLAN_FORM
		db NIGHT_SLASH, EXTREMESPEED, SWORDS_DANCE, PLAY_ROUGH
	db 58, WEAVILE, KINGS_ROCK, 192, ABILITY_1 | NAT_NEUTRAL, FEMALE
		db SWORDS_DANCE, SCREECH, NIGHT_SLASH, ICE_PUNCH
	db 58, GENGAR, SPELL_TAG, 192, ABILITY_1 | NAT_NEUTRAL, FEMALE
		db SHADOW_BALL, WILL_O_WISP, CURSE, DESTINY_BOND
	db 58, HONCHKROW, BLACKGLASSES, 192, ABILITY_1 | NAT_NEUTRAL, FEMALE
		db DRILL_PECK, SUCKER_PUNCH, PURSUIT, BRAVE_BIRD
	db 59, HOUNDOOM, CHARCOAL, 192, ABILITY_1 | NAT_NEUTRAL, FEMALE
