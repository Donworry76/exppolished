...
; ================
	...
	db 59, CELEBI, LEFTOVERS, 192, ABILITY_1 | NAT_NEUTRAL, FEMALE
		db DAZZLINGGLEAM, GIGA_DRAIN, NASTY_PLOT, PSYCHIC
	db -1 ; end
...
; ================
	...
	db 23, UMBREON, LEFTOVERS, 88, ABILITY_1 | NAT_NEUTRAL, MALE
		db TOXIC, PROTECT, SUCKER_PUNCH, RECOVER
	db 33, ENTEI, LEFTOVERS, 88, ABILITY_1 | NAT_NEUTRAL, MALE
