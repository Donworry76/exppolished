...
; ================
	...
	db 59, CELEBI, LEFTOVERS, 192, ABILITY_1 | NAT_NEUTRAL, FEMALE
...
; ================
	...
	db 59, KINGDRA, SCOPE_LENS, 208, ABIL_KINGDRA_SNIPER | NAT_SATK_UP_ATK_DOWN, MALE
		db FOCUS_ENERGY, DRAGON_PULSE, SURF, ICE_BEAM
