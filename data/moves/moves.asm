...
endc
	...
	move WRAP,         EFFECT_TRAP,               20, NORMAL,    100, 20,   0, PHYSICAL
if DEF(FAITHFUL)
...
endc
	...
	move SPARK,        EFFECT_PARALYZE_HIT,       75, ELECTRIC,  100, 20,  30, PHYSICAL
...
endc
	...
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      80, STEEL,     100, 15,  10, PHYSICAL
