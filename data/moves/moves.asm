...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move KARATE_CHOP,  EFFECT_NORMAL_HIT,         60, FIGHTING,  100, 25,   0, PHYSICAL
	move DOUBLE_SLAP,  EFFECT_MULTI_HIT,          20, NORMAL,    100, 10,   0, PHYSICAL
	move AERIAL_ACE,   EFFECT_ALWAYS_HIT,         80, FLYING,    100, 20,   0, PHYSICAL
	move DRAGON_CLAW,  EFFECT_NORMAL_HIT,         80, DRAGON,    100, 15,   0, PHYSICAL
	move PAY_DAY,      EFFECT_PAY_DAY,            70, NORMAL,    100, 20,   0, PHYSICAL
	...
	move X_SCISSOR,    EFFECT_NORMAL_HIT,         90, BUG,       100, 15,   0, PHYSICAL
	move NIGHT_SLASH,  EFFECT_NORMAL_HIT,         70, DARK,      100, 15,   0, PHYSICAL
	move AIR_SLASH,    EFFECT_FLINCH_HIT,         90, FLYING,    100, 15,  30, SPECIAL
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, NORMAL,    100,  5,   0, STATUS
if DEF(FAITHFUL)
	move CUT,          EFFECT_NORMAL_HIT,         50, NORMAL,     95, 30,   0, PHYSICAL
else
	move CUT,          EFFECT_NORMAL_HIT,         70, STEEL,     100, 30,   0, PHYSICAL
endc
	move GUST,         EFFECT_GUST,               60, FLYING,    100, 30,   0, SPECIAL
	move WING_ATTACK,  EFFECT_DOUBLE_HIT,         35, FLYING,    100, 35,   0, PHYSICAL
...
endc
	...
	move STOMP,        EFFECT_STOMP,              75, NORMAL,    100, 20,  30, PHYSICAL
	...
	move STONE_EDGE,   EFFECT_NORMAL_HIT,        110, ROCK,       80,  5,   0, PHYSICAL
	move FOCUS_BLAST,  EFFECT_SP_DEF_DOWN_HIT,   120, FIGHTING,   75,  5,  10, SPECIAL
	...
	move WRAP,         EFFECT_TRAP,               30, NORMAL,    100, 20,   0, PHYSICAL
if DEF(FAITHFUL)
...
endc
	...
	move POISON_STING, EFFECT_POISON_HIT,         40, POISON,    100, 20,  30, PHYSICAL
...
if DEF(FAITHFUL)
	...
	move SUPERSONIC,   EFFECT_CONFUSE,             0, NORMAL,     60, 20,   0, STATUS
else
	move SING,         EFFECT_SLEEP,               0, NORMAL,     75, 15,   0, STATUS
	move SUPERSONIC,   EFFECT_CONFUSE,             0, NORMAL,     75, 20,   0, STATUS
endc
	move SONIC_BOOM,   EFFECT_STATIC_DAMAGE,      30, NORMAL,    100, 20,   0, SPECIAL
	...
	move CALM_MIND,    EFFECT_CALM_MIND,           0, PSYCHIC,   100, 5,    0, STATUS
	...
	move PSYBEAM,      EFFECT_CONFUSE_HIT,        75, PSYCHIC,   100, 20,  10, SPECIAL
	move BUBBLE_BEAM,  EFFECT_SPEED_DOWN_HIT,     75, WATER,     100, 20,  10, SPECIAL
	move AURORA_BEAM,  EFFECT_ATTACK_DOWN_HIT,    75, ICE,       100, 20,  10, SPECIAL
	move HYPER_BEAM,   EFFECT_HYPER_BEAM,        150, NORMAL,    100,  5,   0, SPECIAL
	move PECK,         EFFECT_NORMAL_HIT,         40, FLYING,    100, 35,   0, PHYSICAL
	move DRILL_PECK,   EFFECT_NORMAL_HIT,        100, FLYING,    100, 20,   0, PHYSICAL
...
if DEF(FAITHFUL)
	...
	move STRENGTH,     EFFECT_NORMAL_HIT,        100, ROCK,      100, 15,   0, PHYSICAL
endc
	move ABSORB,       EFFECT_LEECH_HIT,          40, GRASS,     100, 25,   0, SPECIAL
	move MEGA_DRAIN,   EFFECT_LEECH_HIT,          60, GRASS,     100, 15,   0, SPECIAL
	move LEECH_SEED,   EFFECT_LEECH_SEED,          0, GRASS,     100, 10,   0, STATUS
	move GROWTH,       EFFECT_GROWTH,              0, NORMAL,    100, 20,   0, STATUS
	move RAZOR_LEAF,   EFFECT_NORMAL_HIT,         65, GRASS,     100, 25,   0, PHYSICAL
	...
	move STRING_SHOT,  EFFECT_SPEED_DOWN_2,        0, BUG,       100, 20,   0, STATUS
...
endc
	...
	move THUNDER_WAVE, EFFECT_PARALYZE,            0, ELECTRIC,   95, 20,   0, STATUS
	...
	move AVALANCHE,    EFFECT_CONDITIONAL_BOOST,  65, ICE,       100, 10,   0, PHYSICAL
if DEF(FAITHFUL)
...
endc
	...
	move AGILITY,      EFFECT_SPEED_UP_2,          0, PSYCHIC,   100,  5,   0, STATUS
	move QUICK_ATTACK, EFFECT_PRIORITY_HIT,       40, NORMAL,    100, 30,   0, PHYSICAL
	move RAGE,         EFFECT_RAGE,               25, NORMAL,    100, 20,   0, PHYSICAL
	...
	move DOUBLE_TEAM,  EFFECT_EVASION_UP,          0, NORMAL,    100,  5,   0, STATUS
	move RECOVER,      EFFECT_HEAL,                0, NORMAL,    100, 10,   0, STATUS
	move ROCK_BLAST,   EFFECT_MULTI_HIT,          25, ROCK,      100, 25,   0, PHYSICAL
	move MINIMIZE,     EFFECT_MINIMIZE,            0, NORMAL,    100,  5,   0, STATUS
	move SMOKESCREEN,  EFFECT_ACCURACY_DOWN,       0, NORMAL,    100,  5,   0, STATUS
	...
	move BARRIER,      EFFECT_DEFENSE_UP_2,        0, PSYCHIC,   100,  5,   0, STATUS
	...
	move FLASH_CANNON, EFFECT_SP_DEF_DOWN_HIT,    90, STEEL,     100, 10,  10, SPECIAL
if DEF(FAITHFUL)
...
endc
	...
	move LICK,         EFFECT_PARALYZE_HIT,       20, GHOST,      90, 10, 100, PHYSICAL
	...
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          70, BUG,       100, 10,   0, PHYSICAL
	move DRAIN_KISS,   EFFECT_LEECH_HIT,          80, FAIRY,     100, 10,   0, SPECIAL
	...
	move DRAGON_DANCE, EFFECT_DRAGON_DANCE,        0, DRAGON,    100,  5,   0, STATUS
if DEF(FAITHFUL)
...
if DEF(FAITHFUL)
	...
	move FURY_STRIKES, EFFECT_FURY_STRIKES,       25, NORMAL,    100, 15,   0, PHYSICAL
endc
	...
	move HYPER_FANG,   EFFECT_FLINCH_HIT,         80, NORMAL,    100, 15,  20, PHYSICAL
	move BULK_UP,      EFFECT_BULK_UP,             0, FIGHTING,  100, 20,   0, STATUS
	move CONVERSION,   EFFECT_CONVERSION,          0, NORMAL,    100, 30,   0, STATUS
	move TRI_ATTACK,   EFFECT_TRI_ATTACK,         90, NORMAL,    100, 10,  50, SPECIAL
	move SUPER_FANG,   EFFECT_SUPER_FANG,          1, NORMAL,    100, 10,   0, PHYSICAL
	...
	move WILL_O_WISP,  EFFECT_BURN,                0, FIRE,       95, 15,   0, STATUS
	...
	move HYPER_VOICE,  EFFECT_NORMAL_HIT,        100, NORMAL,    100, 10,   0, SPECIAL
	move CURSE,        EFFECT_CURSE,               0, GHOST,     100,  5,   0, STATUS
	...
	move SEED_BOMB,    EFFECT_NORMAL_HIT,        100, GRASS,     100, 15,   0, PHYSICAL
	...
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  30, GROUND,    100, 10, 100, SPECIAL
if DEF(FAITHFUL)
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  85, WATER,      95, 10,  50, SPECIAL
else
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  85, WATER,     100, 10,  50, SPECIAL
endc
	move SPIKES,       EFFECT_SPIKES,              0, GROUND,    100, 20,   0, STATUS
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      150, ELECTRIC,   50,  5, 100, SPECIAL
	...
	move ICY_WIND,     EFFECT_SPEED_DOWN_HIT,     65, ICE,       100, 15, 100, SPECIAL
	move POWER_GEM,    EFFECT_NORMAL_HIT,         90, ROCK,      100, 20,   0, SPECIAL
	move WILD_CHARGE,  EFFECT_RECOIL_HIT,        100, ELECTRIC,  100, 15,   0, PHYSICAL
	...
	move SWAGGER,      EFFECT_SWAGGER,             0, NORMAL,     95, 15, 100, STATUS
	move SHELL_SMASH,  EFFECT_SHELL_SMASH,         0, NORMAL,    100, 15,   0, STATUS
	move SPARK,        EFFECT_PARALYZE_HIT,       85, ELECTRIC,  100, 15,  30, PHYSICAL
...
endc
	...
	move DYNAMICPUNCH, EFFECT_CONFUSE_HIT,       150, FIGHTING,   50, 10, 100, PHYSICAL
...
endc
	...
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      90, STEEL,     100, 10,  20, PHYSICAL
	move AURA_SPHERE,  EFFECT_ALWAYS_HIT,         90, FIGHTING,  100, 20,   0, SPECIAL
	move HEALINGLIGHT, EFFECT_HEALING_LIGHT,       0, NORMAL,    100,  5,   0, STATUS
	move HURRICANE,    EFFECT_CONFUSE_HIT,       120, FLYING,     80, 10,  30, SPECIAL
...
endc
	move CROSS_CHOP,   EFFECT_NORMAL_HIT,         90, FIGHTING,  100,  5,   0, PHYSICAL
	...
	move CRUNCH,       EFFECT_DEFENSE_DOWN_HIT,   95, DARK,      100, 10,  20, PHYSICAL
	move MIRROR_COAT,  EFFECT_MIRROR_COAT,         1, PSYCHIC,   100, 20,   0, SPECIAL
	move NASTY_PLOT,   EFFECT_SP_ATK_UP_2,         0, DARK,      100,  5,   0, STATUS
	move EXTREMESPEED, EFFECT_PRIORITY_HIT,       90, NORMAL,    100,  5,   0, PHYSICAL
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT,         80, ROCK,      100,  5,  10, SPECIAL
	move SHADOW_BALL,  EFFECT_SP_DEF_DOWN_HIT,    90, GHOST,     100, 15,  20, SPECIAL
...
endc
	move DARK_PULSE,   EFFECT_FLINCH_HIT,         90, DARK,      100, 15,  20, SPECIAL
	...
	move DISARM_VOICE, EFFECT_ALWAYS_HIT,         80, FAIRY,     100, 15,   0, SPECIAL
